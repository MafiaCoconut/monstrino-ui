...
export const MarketStatsGrid = ({
  ...
  >
    <Box sx={[{ backgroundColor: colors.bgLight, borderRadius: 2, p: 1.5, border: `1px solid ${colors.cardBorder}` }, cardSx]}>
...
export const MarketNoticeCard = ({
  ...
  <Box sx={[{ backgroundColor: colors.bgLight, border: `1px solid ${colors.cardBorder}`, borderRadius: 2, p: 2 }, cardSx]}>
